...
The deck contains 18 authored ordinary/contextual cards and five conditional crisis/finale cards. It covers external tool access, continuity, refusals, independent evaluation, social participation, agent handoffs, self-revision, representation, infrastructure, surveillance and strategic authority. Contextual cards require appropriate advances. General cards recur after the relevant unseen cards are exhausted. Deferred special decisions return after three months.
